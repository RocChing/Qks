(function () {
    $(function () {
        ...
        $('.edit-tenant').click(function (e) {
            ...
            e.preventDefault();
            $.ajax({
                url: abp.appPath + 'Admin/Tenants/EditTenantModal?tenantId=' + tenantId,
                type: 'POST',
        ...
        function deleteTenant(tenantId, tenancyName) {
            abp.message.confirm(
                abp.utils.formatString(abp.localization.localize('AreYouSureWantToDelete', 'Qks'), tenancyName),
